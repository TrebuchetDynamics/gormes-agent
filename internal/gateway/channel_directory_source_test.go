...
func TestRememberedSourceEntry_FormatsHermesSessionDirectoryFields(t *testing.T) {
	telegram := RememberedSourceEntryFromSessionSource(SessionSource{
		Platform:  "telegram",
		ChatID:    " -1001 ",
	...
	discord := RememberedSourceEntryFromSessionSource(SessionSource{
		Platform:     "discord",
		ChatID:       "thread-2",
		ChatName:     "triage",
		ChatType:     "thread",
