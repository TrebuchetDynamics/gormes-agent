...
| `skills/**`, `optional-skills/**` | Skill manager, slash skills, learning loop | `internal/skills`, `docs/development-skills`, `cmd/gormes`; source-backed integration-claim classifications live in [Hermes Integrations Claim Audit](../hermes-integrations-claim-audit/) | Phase 5.F, 6 | planned |
