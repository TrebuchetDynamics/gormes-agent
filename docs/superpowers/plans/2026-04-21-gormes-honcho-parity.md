...
**Files:**
- Create: `docs/superpowers/specs/2026-04-21-gormes-honcho-parity-design.md`
- Create: `internal/honcho/contracts_test.go`
...
**Files:**
- Modify: `internal/memory/schema.go` (new migration `3d -> 3e` or next free tag)
- Modify: `internal/memory/migrate.go`
- Create: `internal/memory/honcho_sql.go`
- Create: `internal/memory/honcho_sql_test.go`
...
**Files:**
- Create: `internal/honcho/service.go`
- Create: `internal/honcho/types.go`
- Create: `internal/honcho/service_test.go`
...
**Files:**
- Create: `internal/tools/honcho_tools.go`
- Modify: `gormes/cmd/gormes/registry.go`
- Create: `internal/tools/honcho_tools_test.go`
...
**Files:**
- Create: `internal/honcho/reasoning.go`
- Create: `internal/honcho/reasoning_test.go`
...
- Create: `internal/doctor/honcho_check.go`
- Modify: `README.md`
