	...
	p := &Progress{
		Meta: Meta{
			...
			BuilderLoop: BuilderLoopMeta{
				...
				Plan:            "webpages/docs/superpowers/plans/orchestration-planner/2026-04-24-autoloop-repoctl-go-port.md",
				AgentQueue:      "webpages/docs/content/building-gormes/autoloop/agent-queue.md",
				ProgressSchema:  "webpages/docs/content/building-gormes/autoloop/progress-schema.md",
	...
	p := &Progress{
		...
		Phases: map[string]Phase{"1": {Subphases: map[string]Subphase{
			"1.A": {Items: []Item{{
				...
				SourceRefs:     []string{"webpages/docs/content/building-gormes/autoloop/progress-schema.md"},
	...
	p := &Progress{
		...
		Phases: map[string]Phase{"1": {Subphases: map[string]Subphase{
			"1.A": {Items: []Item{{
				...
				TestCommands:   []string{"go test ./internal/llm -count=1"},
