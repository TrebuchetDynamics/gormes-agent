...
| WhatsApp | `gateway/platforms/whatsapp.py`, `gateway/whatsapp_identity.py` | 2.B.4 | 🔨 in progress | Transport-neutral ingress normalization, command passthrough, and bridge-vs-native runtime selection live in `internal/channels/whatsapp`; identity resolution, self-chat guards, pairing/reconnect/send still remain |
