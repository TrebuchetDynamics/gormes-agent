...
func TestHomeAssistantToolRegistrationRequiresToken(t *testing.T) {
	...
	reg := NewRegistry()
	RegisterHomeAssistantTools(reg, HomeAssistantConfig{Client: &fakeHomeAssistantClient{}})
...
func mustHomeAssistantTool(t *testing.T, name string, cfg HomeAssistantConfig) Tool {
	t.Helper()
