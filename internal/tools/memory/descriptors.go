...
var memoryToolDescriptors = []toolkit.ToolDescriptor{
	{
...
func MemoryToolDescriptors() []toolkit.ToolDescriptor {
	out := make([]toolkit.ToolDescriptor, 0, len(memoryToolDescriptors))
...
// memory tools.
func MemoryToolOperationSpecs() []toolkit.OperationSpec {
	descriptors := MemoryToolDescriptors()
	out := make([]toolkit.OperationSpec, 0, len(descriptors))
...
func MemoryToolOperationSpec(name string) (toolkit.OperationSpec, bool) {
	...
	return toolkit.OperationSpec{}, false
}

func memoryToolOperationSpec(descriptor toolkit.ToolDescriptor) toolkit.OperationSpec {
	spec := toolkit.OperationSpec{
...
func cloneMemoryToolDescriptor(descriptor toolkit.ToolDescriptor) toolkit.ToolDescriptor {
