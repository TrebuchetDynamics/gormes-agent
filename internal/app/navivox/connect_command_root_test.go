...
func TestNavivoxConnectInfo_LayeredAuthRequiresToken(t *testing.T) {
	...
	t.Cleanup(func() { vpnhostList = prev })
	vpnhostList = func(context.Context) ([]VPNHost, error) {
		return []VPNHost{{Iface: "tailscale0", Kind: VPNHostKindTailscale, IPv4: "100.64.1.2"}}, nil
	}
...
func TestNavivoxConnectInfo_JSONIncludesWebSocketURLAndBracketsIPv6(t *testing.T) {
	...
	vpnhostList = func(context.Context) ([]VPNHost, error) {
		return []VPNHost{
			{Iface: "tailscale0", Kind: VPNHostKindTailscale, IPv6: "fd7a:115c:a1e0::1"},
		}, nil
	}
...
func TestNavivoxConnectInfo_TailscaleMode_JSONShowsVPNEntries(t *testing.T) {
	...
	vpnhostList = func(context.Context) ([]VPNHost, error) {
		return []VPNHost{
			{Iface: "tailscale0", Kind: VPNHostKindTailscale, IPv4: "100.64.1.2", IPv6: "fd7a::1"},
		}, nil
	}
...
func TestNavivoxConnectInfo_VPNMode_ListsAllDetectedKinds(t *testing.T) {
	...
	vpnhostList = func(context.Context) ([]VPNHost, error) {
		return []VPNHost{
			{Iface: "tailscale0", Kind: VPNHostKindTailscale, IPv4: "100.64.1.2"},
			{Iface: "wg0", Kind: VPNHostKindWireGuard, IPv4: "10.0.0.1"},
			{Iface: "tun0", Kind: VPNHostKindTunOther, IPv4: "10.8.0.5"},
		}, nil
	}
