...
type ChatOption func(*ChatScreen)
...
func (s *ChatScreen) Title() string { return "Chat" }

func (s *ChatScreen) Init() tea.Cmd { return textinput.Blink }
...
func (s *ChatScreen) ShortHelp() []KeyHelp {
	return []KeyHelp{
...
func (s *ChatScreen) submit() (Screen, tea.Cmd) {
...
func (s *ChatScreen) loadAgentsCmd() tea.Cmd {
	lister := s.agents
	return func() tea.Msg {
...
func (s *ChatScreen) updateAgentPicker(msg tea.KeyMsg) (Screen, tea.Cmd) {
	switch msg.String() {
	case "esc":
		s.pickerOpen = false
	case "up", "k":
...
func (s *ChatScreen) renderAgentPicker() string {
	var b strings.Builder
