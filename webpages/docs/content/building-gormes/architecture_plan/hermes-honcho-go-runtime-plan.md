...
| Gormes-owned progress-json and abort contract | `../gormes/docs/progress-events.md`, `../gormes/src/core/backoff.ts`, `../gormes/src/core/minions/queue.ts`, `../gormes/src/core/errors.ts` | `cmd/gormes`, `internal/audit`, `internal/doctor` | Phase 2.E, 5.O, 6 |
