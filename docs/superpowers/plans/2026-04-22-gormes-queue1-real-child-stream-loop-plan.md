...
```bash
cd <repo>
git add docs/content/building-gormes/architecture_plan/progress.json docs/content/building-gormes/architecture_plan/phase-2-gateway.md docs/content/building-gormes/architecture_plan/subsystem-inventory.md docs/content/building-gormes/architecture_plan/why-go.md docs/content/building-gormes/architecture_plan/_index.md README.md
