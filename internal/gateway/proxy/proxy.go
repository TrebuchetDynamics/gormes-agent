...
// RuntimeStatusUpdate carries the proxy status fields this package writes.
...
// RuntimeStatusWriter receives proxy status updates without depending on the root gateway package.
