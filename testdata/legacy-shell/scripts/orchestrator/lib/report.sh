...
build_prompt() {
  ...
  autoloop_agent_queue="$(json_autoloop_scalar_or_default "$selected_json" agent_queue "webpages/docs/content/building-gormes/autoloop/agent-queue.md")"
  autoloop_progress_schema="$(json_autoloop_scalar_or_default "$selected_json" progress_schema "webpages/docs/content/building-gormes/autoloop/progress-schema.md")"
