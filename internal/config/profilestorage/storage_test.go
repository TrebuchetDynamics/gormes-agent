...
func TestProfileStorageContractLegacyRootPreservesCurrentDBPaths(t *testing.T) {
	...
	contract := Current()
	if contract.Scope != ScopeBaseHome || contract.Root != home || contract.BaseHome != home {
...
func TestProfileStorageContractMaterializedMainPreservesCurrentDBPaths(t *testing.T) {
	...
	contract := Current()
	if contract.Scope != ScopeProfileRoot || contract.ProfileID != DefaultProfileID || contract.Root != mainRoot || contract.BaseHome != home {
...
func TestProfileStorageContractActiveNamedProfilePreservesCurrentDBPaths(t *testing.T) {
	...
	contract := Current()
	if contract.Scope != ScopeProfileRoot || contract.ProfileID != "coder" || contract.Root != profileRoot || contract.BaseHome != base {
