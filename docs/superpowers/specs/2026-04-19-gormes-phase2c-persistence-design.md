...
- [`docs/ARCH_PLAN.md`](../../ARCH_PLAN.md) — executive roadmap; Phase 3 ("The Black Box") owns the eventual SQLite + FTS5 memory layer. Phase 2.C is a surgical predecessor that solves the restart-UX bug without anticipating Phase 3.
