...
**Goal:** Add a Pages-compatible static exporter for `www.gormes.ai` that writes `dist/index.html` and `dist/static/*` from the same rendering core used by the HTTP server.
...
- Add: `www.gormes.ai/internal/site/export_test.go`
- Test: `www.gormes.ai/internal/site/render_test.go`
- Test: `www.gormes.ai/internal/site/export_test.go`
...
**Files:**
- Add: `www.gormes.ai/cmd/www-gormes-export/main.go`
