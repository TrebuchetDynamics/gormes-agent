...
description: "Drive the macOS desktop in the background with the computer_use toolset and cua-driver."
weight: 13
---
...
- [Browser automation](../browser/) for cross-platform web tasks.
