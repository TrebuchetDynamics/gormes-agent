...
| `gateway.display_config.tool_progress` | `../hermes-agent/gateway/display_config.py`; `../hermes-agent/gateway/run.py:/verbose` | `internal/gateway` renderer/manager defaults plus planned config rows | functional | planned | draft |
