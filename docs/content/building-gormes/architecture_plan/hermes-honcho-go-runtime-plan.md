...
| Goncho OpenAPI v3 route manifest and unsupported-route contract | `../honcho/docs/v3/openapi.json`, `../honcho/src/routers/*.py`, `../honcho/tests/routes/**` | `internal/goncho/compat`, optional `internal/apiserver` adapter | Phase 3.G, 5.Q |
