...
func TestSlackManifestFullManifestAppHomeAndScopes(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newRootCommandWithRuntime(rootRuntime{}), "slack", "manifest", "--name", "Gormes Test Bot", "--description", "Test Slack manifest")
	if err != nil {
...
func TestSlackManifestSlashesOnly(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newRootCommandWithRuntime(rootRuntime{}), "slack", "manifest", "--slashes-only")
	if err != nil {
...
func TestSlackManifestWriteDefaultAndCustomPath(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newRootCommandWithRuntime(rootRuntime{}), "slack", "manifest", "--write")
	if err != nil {
	...
	stdout, stderr, err = executeRootCommandForTest(newRootCommandWithRuntime(rootRuntime{}), "slack", "manifest", "--write="+customPath, "--slashes-only")
	if err != nil {
