...
`docs/content/building-gormes/architecture_plan/progress.json` is nominally
...
- Landing page (`www.gormes.ai/internal/site/content.go` line 157):
  **"8/52 shipped"** — stale
...
New Go package at `internal/progress/`:
