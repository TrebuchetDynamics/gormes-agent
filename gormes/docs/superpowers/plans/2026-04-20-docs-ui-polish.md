...
**Reference spec:** `gormes/docs/superpowers/specs/2026-04-20-docs-ui-polish-design.md`
...
```bash
cd gormes/docs/www-tests && npm run test:e2e -- home.spec.mjs
```
...
```bash
cd gormes && go test ./docs -run TestHugoBuild -count=1
cd gormes/docs/www-tests && npm run test:e2e -- home.spec.mjs mobile.spec.mjs
```
...
```bash
wc -l gormes/docs/static/site.css gormes/docs/static/site.js
```
