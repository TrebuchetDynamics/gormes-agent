...
**Module:** `gateway`
**Rows:** 154
**Status counts:** `complete`: 152 · `in_progress`: 0 · `planned`: 2
**Priority counts:** `P0`: 14 · `P1`: 45 · `P2`: 37 · `P3`: 3 · `P4`: 1 · `unset`: 54
...
| `planned` | `P2` | `gateway` | Kernel cross-provider client swap for in-session model switch |
