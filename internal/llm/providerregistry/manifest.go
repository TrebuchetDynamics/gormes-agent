...
func HermesProviderRegistryManifest() []ProviderManifestEntry {
	entries := []ProviderManifestEntry{
		...
		{ID: "gemini", Aliases: []string{"google", "google-ai-studio", "google-gemini"}, ModelsDevID: "google", TransportFamily: "openai_chat", AuthType: "api_key", Aggregator: false, EnvVars: []string{"GOOGLE_API_KEY", "GEMINI_API_KEY"}, BaseURLOverride: "https://generativelanguage.googleapis.com/v1beta/openai", BaseURLEnvVar: "GEMINI_BASE_URL", ImplementationStatus: ProviderImplemented},
		...
		{ID: "gollmfree", Aliases: []string{"free", "gollm-free"}, ModelsDevID: "", TransportFamily: "gollmfree", AuthType: "none", Aggregator: true, EnvVars: nil, BaseURLOverride: "", BaseURLEnvVar: "", ImplementationStatus: ProviderOwned},
		...
		{ID: "groq", Aliases: nil, ModelsDevID: "groq", TransportFamily: "openai_chat", AuthType: "api_key", Aggregator: false, EnvVars: []string{"GROQ_API_KEY"}, BaseURLOverride: "https://api.groq.com/openai/v1", BaseURLEnvVar: "GROQ_BASE_URL", ImplementationStatus: ProviderImplemented},
		...
		{ID: "minimax-oauth", Aliases: []string{"minimax-global", "minimax-portal", "minimax_oauth"}, ModelsDevID: "minimax", TransportFamily: "anthropic_messages", AuthType: "oauth_minimax", Aggregator: false, EnvVars: nil, BaseURLOverride: "https://api.minimax.io/anthropic", BaseURLEnvVar: "", ImplementationStatus: ProviderRowBacked},
		...
		{ID: "novita", Aliases: []string{"novita-ai", "novitaai"}, ModelsDevID: "novita-ai", TransportFamily: "openai_chat", AuthType: "api_key", Aggregator: true, EnvVars: []string{"NOVITA_API_KEY"}, BaseURLOverride: "https://api.novita.ai/openai/v1", BaseURLEnvVar: "NOVITA_BASE_URL", ImplementationStatus: ProviderImplemented},
		...
		{ID: "openrouter", Aliases: []string{"openai", "open-router", "or", "openrouter-free"}, ModelsDevID: "openrouter", TransportFamily: "openai_chat", AuthType: "api_key", Aggregator: true, EnvVars: []string{"OPENROUTER_API_KEY", "OPENAI_API_KEY"}, BaseURLOverride: "https://openrouter.ai/api/v1", BaseURLEnvVar: "OPENROUTER_BASE_URL", ImplementationStatus: ProviderImplemented},
