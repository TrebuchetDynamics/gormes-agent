...
func NewCommand() *cobra.Command {
	return NewCommandWithDeps(CommandDeps{})
}

func NewCommandWithDeps(deps CommandDeps) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "curator",
...
func newCuratorStatusCommand(deps CommandDeps) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "status",
...
func newCuratorEffectivenessCommand(deps CommandDeps) *cobra.Command {
	var asJSON bool
...
func newCuratorRunCommand(deps CommandDeps) *cobra.Command {
	var dryRun bool
...
func newCuratorPauseCommand(deps CommandDeps) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "pause",
...
func newCuratorResumeCommand(deps CommandDeps) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "resume",
...
func runCuratorPauseFlip(cmd *cobra.Command, deps CommandDeps, pausedAfter bool, action string) error {
	root := resolveCuratorSkillsRoot(deps)
	curator := newCuratorForCommand(root, deps)
	state, err := curator.LoadState()
	if err != nil {
...
func newCuratorPinCommand(deps CommandDeps) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "pin <skill>",
...
func newCuratorUnpinCommand(deps CommandDeps) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "unpin <skill>",
...
func newCuratorBackupCommand(deps CommandDeps) *cobra.Command {
	var reason string
	var asJSON bool
	cmd := &cobra.Command{
		Use:   "backup",
...
func newCuratorRollbackCommand(deps CommandDeps) *cobra.Command {
	var list bool
	var backupID string
	var yes bool
	var asJSON bool
...
func newCuratorRestoreCommand(deps CommandDeps) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "restore <skill>",
...
func newCuratorListArchivedCommand(deps CommandDeps) *cobra.Command {
...
func newCuratorArchiveCommand(deps CommandDeps) *cobra.Command {
	return &cobra.Command{
		Use:   "archive <skill>",
...
func newCuratorPruneCommand(deps CommandDeps) *cobra.Command {
	var days int
	var dryRun bool
	var yes bool
	cmd := &cobra.Command{
...
func runCuratorPrune(cmd *cobra.Command, deps CommandDeps, days int, dryRun, yes bool) error {
	if days < 1 {
...
func ResolveSkillsRoot(deps CommandDeps) string {
...
func resolveCuratorSkillsRoot(deps CommandDeps) string { return ResolveSkillsRoot(deps) }

func newCuratorForCommand(root string, deps CommandDeps) *skills.Curator {
...
func curatorNow(deps CommandDeps) time.Time {
	if deps.Now != nil {
		return deps.Now().UTC()
	}
	return time.Now().UTC()
...
func FormatTimestamp(ts *time.Time, deps CommandDeps) string {
	if ts == nil || ts.IsZero() {
		return "never"
	}
	now := curatorNow(deps)
...
func formatCuratorTimestamp(ts *time.Time, deps CommandDeps) string { return FormatTimestamp(ts, deps) }
