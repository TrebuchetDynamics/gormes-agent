...
| 8 / 8.D | Gormes-owned semantic chat style system | Gormes-owned chat TUI divergence ratification | Gormes-owned chat TUI divergence ratification is complete (R0 goldens no longer forbid role-differentiated rendering). | - |
...
| 8 / 8.D | Gormes welcome panel version/tool-count wiring | Gormes-owned session-aware welcome panel | Gormes-owned session-aware welcome panel is complete (panel exists with the version best-effort/omit seam). | - |
<!-- PROGRESS:END -->
