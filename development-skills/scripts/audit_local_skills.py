...
BAD_PATTERNS = {
    ...
    r"implementation intent goes into `docs/parity-evidence/HERMES-BEHAVIOR-ATOMS\.md`": "implementation intent must go into the progress control plane",
    r"Put implementation intent in the parity evidence doc": "implementation intent must go into the progress control plane",
    r"represented in `docs/parity-evidence/HERMES-BEHAVIOR-ATOMS\.md` only": "progress rows are the backlog-safe representation",
