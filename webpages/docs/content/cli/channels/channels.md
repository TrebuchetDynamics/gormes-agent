...
| Discord | Runtime-ready | [Discord](../../runtime/gateway/) | `gormes channels capabilities --channel discord`; `gormes gateway status --json` | Shared gateway path with configured bot token and channel/guild allowlists. |
