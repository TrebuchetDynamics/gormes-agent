// Package text ports unbranded Hermes prompt-builder guidance constants
...
var ToolUseEnforcementModels = []string{"gpt", "codex", "gemini", "gemma", "grok", "glm", "qwen", "deepseek"}
