---
title: "Docs Module Roadmap"
aliases:
  - /building-gormes/modules/docs/
---
...
**Module:** `docs`
**Rows:** 22
**Status counts:** `complete`: 19 · `in_progress`: 0 · `planned`: 3
**Priority counts:** `P1`: 13 · `P2`: 7 · `P3`: 2
...
|---|---|---|---|
| `complete` | `P1` | `docs` | TD engineering blog scaffolded and live |
| `planned` | `P3` | `docs` | TD social presence connected to blog feed |
...
| `complete` | `P2` | `docs` | Hermes integrations claim audit + source-backed plugin/skill parity map |
...
| Status | Priority | Module | Row |
|---|---|---|---|
| `complete` | `P3` | `docs` | Built-with-Gormes page scaffold |
| `complete` | `P1` | `docs` | Upstream Hermes user-stories static mirror |
