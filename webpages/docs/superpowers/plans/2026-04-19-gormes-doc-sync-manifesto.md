...
- Keep edits inside `README.md` and `docs/**`; do not touch `../../website/docs` or any Python path.
...
- Test: `docs/landing_page_docs_test.go`

- [ ] **Step 1: Write the failing tests**

Add the following tests to `docs/landing_page_docs_test.go`:
...
Update `docs/docs_test.go` so the targets list includes the new spec/plan and the mirror test explicitly allows the one Gormes-native page:
...
Append this test to `docs/landing_page_docs_test.go`:
...
- Create: `docs/content/why-gormes.md`
- Test: `docs/docs_test.go`
- Test: `docs/landing_page_docs_test.go`

- [ ] **Step 1: Write the failing public-surface tests**

Add these tests to `docs/landing_page_docs_test.go`:
...
Update the rendered-content check in `docs/docs_test.go` to:
...
Replace `docs/content/_index.md` with:
...
| **[Roadmap](https://github.com/TrebuchetDynamics/gormes-agent/blob/main/docs/ARCH_PLAN.md)** | The five-phase path from tactical bridge to pure Go runtime |
...
Create `docs/content/why-gormes.md` with:
...
- Modify: `docs/superpowers/specs/2026-04-19-gormes-phase2-tools-design.md`
- Modify: `docs/superpowers/specs/2026-04-19-gormes-phase2b-telegram.md`
- Modify: `docs/landing_page_docs_test.go`
- Test: `docs/landing_page_docs_test.go`
...
Create `docs/superpowers/specs/README.md` with:
...
Insert this block after the vocabulary decision in `docs/superpowers/specs/2026-04-19-gormes-phase2-tools-design.md`:
...
Insert this block after the vocabulary decision in `docs/superpowers/specs/2026-04-19-gormes-phase2b-telegram.md`:
