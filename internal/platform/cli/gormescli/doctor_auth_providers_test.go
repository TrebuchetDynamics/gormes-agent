...
`))
	...
	root := newRootCommandWithFactoryForTest("doctor", func() *cobra.Command {
		return NewDoctorCommand(DoctorCommandOptions{})
	})
	stdout, stderr, err := executeRootCommandForTest(root, "doctor", "--offline")
	if err != nil {
