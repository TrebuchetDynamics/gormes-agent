...
// NormalizeSkin returns the default Hermes/Gormes skin when callers pass a
// zero-value skin. Subpackages use this to keep fallback policy in one place.
func NormalizeSkin(skin HermesSkin) HermesSkin {
