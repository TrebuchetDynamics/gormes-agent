...
// Version is the pure input model for startup banner version text.
type Version struct {
	AgentName   string
	Version     string
	ReleaseDate string
...
// GitState captures the already-resolved git facts shown in the banner.
...
// FormatVersionLabel returns the deterministic version label used in the CLI
// startup banner. Git state is injected by callers so this helper remains file,
// subprocess, and network inert.
func FormatVersionLabel(version Version) string {
