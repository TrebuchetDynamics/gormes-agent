...
const (
	...
	OpenClawResidueCleanupFlag = onboarding.OpenClawResidueCleanupFlag
	OpenClawResidueFlag        = onboarding.OpenClawResidueFlag
)
...
func OnboardingSeen(config map[string]any, flags ...string) bool {
	return onboarding.OnboardingSeen(config, flags...)
}
...
func MarkOnboardingSeen(config map[string]any, flags ...string) map[string]any {
	return onboarding.MarkOnboardingSeen(config, flags...)
}
