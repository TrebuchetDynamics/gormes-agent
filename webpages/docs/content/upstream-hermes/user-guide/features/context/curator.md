...
- [Skills System](../skills/) — how skills work in general and the self-improvement loop that creates them
- [Memory](../memory/) — a parallel background review that maintains long-term memory
