...
If you want to clone the repo and install from source — for contributing, running from a specific branch, or having full control over the virtual environment — see the [Development Setup](../../developer-guide/contributing/#development-setup) section in the Contributing guide.
