...
contains 1,178 row objects: 1,174 complete and 4 planned. The generated
...
| Phase 5 — Final Purge | 1 | `Goscrapling local crawler adapter gate for web_crawl` remains planned and blocked on dependency/source-selection gates rather than builder-ready code work. |
