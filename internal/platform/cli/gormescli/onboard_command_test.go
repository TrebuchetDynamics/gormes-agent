...
type onboardCommandSeams = OnboardCommandSeams
...
func newOnboardCommandWithSeams(seams onboardCommandSeams) *cobra.Command {
	return NewOnboardCommand(OnboardCommandOptions{
		BuildProvenance: func() OnboardBuildProvenance {
			return OnboardBuildProvenance{Version: Version, GitCommit: "test-git"}
		},
		Seams: seams,
	})
}
