...
| 2 / 2.F.5 | Mid-run steer injection between tool calls | `docs` | The row is inventory-only and must not be selected until a planner pass replaces this note with a builder-ready contract packet. | - |
