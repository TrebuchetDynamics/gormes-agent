...
type Registry = contracts.AgentsRegistry
...
func NewScreen(opts ...Option) *Screen {
	s := &Screen{registry: memoryAgentsRegistry{}}
...
func (s *Screen) Title() string { return "Agents" }
...
func (s *Screen) refreshCmd() tea.Cmd {
	registry := s.registry
	return func() tea.Msg {
...
func (s *Screen) updateWizard(msg tea.Msg) (contracts.Screen, tea.Cmd) {
...
func (s *Screen) createCmd(opts goncho.CreateAgentOptions) tea.Cmd {
	registry := s.registry
	return func() tea.Msg {
...
func (s *Screen) bindCmd(agentID string, match goncho.BindingMatch) tea.Cmd {
	registry := s.registry
	return func() tea.Msg {
...
func (s *Screen) unbindCmd(match goncho.BindingMatch) tea.Cmd {
	registry := s.registry
	return func() tea.Msg {
