...
| `gateway.tool_progress.render` | `../hermes-agent/gateway/run.py:progress_callback`; `../hermes-agent/gateway/run.py:send_progress_messages`; `../hermes-agent/agent/display.py:get_tool_emoji` | `internal/gateway/render.go:FormatToolProgressPlain`; `internal/gateway/render.go:FormatToolProgressTelegram`; `internal/gateway/manager.go:dispatchToolProgress` | functional | covered | validated |
...
| `gateway.display_config.tool_progress` | `../hermes-agent/gateway/display_config.py`; `../hermes-agent/gateway/run.py:/verbose` | `internal/config/config.go`; `cmd/gormes/gateway.go`; `internal/gateway/manager.go`; remaining `/verbose` persistence row | functional | partial | validated for config load/wiring; `/verbose` remains planned |
...
| `tools.file_read.schema_safety` | `../hermes-agent/tools/file_tools.py:READ_FILE_SCHEMA`; `../hermes-agent/tools/file_tools.py:read_file_tool`; `../hermes-agent/tools/file_operations.py` | `internal/tools/file_read_guard.go`; future native `read_file` handler row | functional | planned | draft |
| `tools.search_files.schema_result` | `../hermes-agent/tools/file_tools.py:SEARCH_FILES_SCHEMA`; `../hermes-agent/tools/file_tools.py:search_tool` | future native `search_files` handler row; current renderer/tool manifest evidence | strict for schema, functional for implementation | planned | draft |
| `tools.registry.descriptor` | `../hermes-agent/tools/registry.py`; `../hermes-agent/model_tools.py`; `../hermes-agent/toolsets.py` | `internal/tools`; `internal/tools/testdata/upstream_tool_parity_manifest.json`; `cmd/gormes/registry.go` | strict for names/schema, functional for Go execution | planned | draft |
