...
// ProviderCatalogEntry is one Hermes-compatible provider picker row.
...
func HermesProviderCatalog() []ProviderCatalogEntry {
	...
	return append([]ProviderCatalogEntry(nil), entries...)
}
...
func HermesModelProviderCatalog() []ProviderCatalogEntry {
	...
	entries := make([]ProviderCatalogEntry, 0, len(catalog))
