...
func DefaultConfig(home string) AgentsCfg {
	return AgentsCfg{
		List: []AgentCfg{{
			ID:        DefaultAgentID,
			Name:      "Main",
...
func NormalizeConfig(home string, agents *AgentsCfg, bindings []AgentBindingCfg) error {
...
func NormalizeBindings(bindings []AgentBindingCfg) []AgentBindingCfg {
