...
type gatewayModelPickerResolver struct {
...
func NewModelPickerResolver(ov *SessionModelOverride) ModelPickerResolver {
	return &gatewayModelPickerResolver{
		pickerState: &modelPickerManager{},
		override:    ov,
	}
}
...
func (r *gatewayModelPickerResolver) HandleModelPickerCallback(ctx context.Context, cb ModelPickerCallback) (ModelPickerResponse, error) {
...
func (r *gatewayModelPickerResolver) handleModelSelection(cb ModelPickerCallback, state modelPickerState) (ModelPickerResponse, error) {
	modelIdx := 0
	if cb.Value != "" {
...
func (r *gatewayModelPickerResolver) handleBack(cb ModelPickerCallback, state modelPickerState) (ModelPickerResponse, error) {
