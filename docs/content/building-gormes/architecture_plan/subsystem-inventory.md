...
| BlueBubbles (iMessage) | `gateway/platforms/bluebubbles.py` | 2.B.10 | 🔨 first-pass shipped | Webhook-auth, cached chat-GUID resolution, and home-channel send fallback live in `internal/channels/bluebubbles`; upstream f731c2c2 iMessage bubble formatting is now tracked as a follow-up parity slice |
