...
type buildProvenanceJSON = VersionBuildProvenance

func newCuratorRootCommandForTest() *cobra.Command {
	return newRootCommandWithFactoryForTest("curator", func() *cobra.Command {
		return NewCuratorCommandWithDeps(CuratorCommandDeps{}, testBuildProvenance)
	})
}
...
func TestCuratorCommand_Status(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "status")
	if err != nil {
...
func TestCuratorCommand_StatusMultilineSummary(t *testing.T) {
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "status", "--json")
	if err != nil {
...
func TestCuratorCommand_BackupJSONEmitsStructuredOutcome(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "backup", "--reason", "pre-deploy", "--json")
	if err != nil {
...
func TestCuratorCommand_RunDryRunPauseResumePinUnpin(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "run", "--dry-run", "--sync")
	if err != nil {
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "pause")
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "resume")
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "pin", "agent-skill")
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "unpin", "agent-skill")
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "pin", "bundled-skill")
	if err == nil {
...
func TestCuratorCommand_BackupRollbackRestore(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "backup", "--reason", "manual-test")
	if err != nil {
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "rollback", "--id", backupID, "--yes")
	if err != nil {
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "rollback", "--list")
	if err != nil {
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "restore", "archived-skill")
	if err != nil {
...
func TestCuratorCommand_ArchiveListArchivedPrune(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "archive", "pinned")
	if err == nil {
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "archive", "manual")
	if err == nil {
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "archive", "archive-now")
	if err != nil {
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "list-archived")
	if err != nil {
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "prune", "--days", "0")
	if err == nil {
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "prune", "--days", "90", "--dry-run")
	if err != nil {
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "prune", "--days", "90", "--yes")
	if err != nil {
...
func TestCuratorCommand_RollbackJSONEmitsStructuredOutcome(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "backup", "--reason", "rollback-test")
	if err != nil {
		t.Fatalf("curator backup: %v\nstdout=%s\nstderr=%s", err, stdout, stderr)
	}
	backupID := newestCuratorBackupID(t, root)
	...
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "rollback", "--id", backupID, "--yes", "--json")
	if err != nil {
...
func TestCuratorCommand_RollbackListJSONEmitsBackupArray(t *testing.T) {
	...
	stdout, _, err := executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "backup", "--reason", "test-list")
	if err != nil {
		t.Fatalf("curator backup: %v\nstdout=%s", err, stdout)
	}
	backupID := newestCuratorBackupID(t, root)

	stdout, stderr, err := executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "rollback", "--list", "--json")
	if err != nil {
...
func TestCuratorCommand_RunJSON(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "run", "--dry-run", "--json")
	if err != nil {
...
func TestCuratorCommand_RestoreJSON(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "restore", "archived-alpha", "--json")
	if err != nil {
...
func TestCuratorCommand_PinUnpinJSON(t *testing.T) {
	...
	// pin --json
	stdout, stderr, err := executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "pin", "alpha", "--json")
	if err != nil {
	...
	// unpin --json
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "unpin", "alpha", "--json")
	if err != nil {
...
func TestCuratorCommand_PauseResumeJSON(t *testing.T) {
	...
	// pause --json
	stdout, stderr, err := executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "pause", "--json")
	if err != nil {
	...
	// resume --json
	stdout, stderr, err = executeRootCommandForTest(newCuratorRootCommandForTest(), "curator", "resume", "--json")
	if err != nil {
...
func TestRootCommandIncludesCuratorCommand(t *testing.T) {
	root := newCuratorRootCommandForTest()
