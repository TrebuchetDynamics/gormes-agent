...
func HermesProviderRegistryManifest() []ProviderManifestEntry {
	entries := []ProviderManifestEntry{
		...
		{ID: "opencode", Aliases: []string{"opencode-zen", "zen"}, ModelsDevID: "opencode", TransportFamily: "openai_chat", AuthType: "api_key", Aggregator: true, EnvVars: []string{"OPENCODE_ZEN_API_KEY"}, BaseURLOverride: "https://opencode.ai/zen/v1", BaseURLEnvVar: "OPENCODE_ZEN_BASE_URL", ImplementationStatus: ProviderRowBacked},
		{ID: "opencode-go", Aliases: []string{"go", "opencode-go-sub"}, ModelsDevID: "opencode-go", TransportFamily: "openai_chat", AuthType: "api_key", Aggregator: true, EnvVars: []string{"OPENCODE_GO_API_KEY"}, BaseURLOverride: "https://opencode.ai/zen/go/v1", BaseURLEnvVar: "OPENCODE_GO_BASE_URL", ImplementationStatus: ProviderRowBacked},
		{ID: "openrouter", Aliases: []string{"openai"}, ModelsDevID: "openrouter", TransportFamily: "openai_chat", AuthType: "api_key", Aggregator: true, EnvVars: []string{"OPENAI_API_KEY"}, BaseURLOverride: "", BaseURLEnvVar: "OPENROUTER_BASE_URL", ImplementationStatus: ProviderImplemented},
