...
**Tech Stack:** Go stdlib (`os`, `path/filepath`, `strings`, `sort`, `time`), existing `internal/kernel`, existing `internal/config`, new `internal/skills` package, docs test harness.
...
- Create: `internal/skills/selector.go`
- Create: `internal/skills/render.go`
- Create: `internal/skills/usage.go`
- Create: `internal/skills/*_test.go`
...
```bash
git add internal/skills/types.go internal/skills/parser.go internal/skills/types_test.go internal/skills/parser_test.go
...
- `internal/config/config_test.go` additions for skills-root defaults
...
```bash
git add internal/skills/store.go internal/skills/store_test.go internal/config/config.go internal/config/config_test.go
...
- `internal/skills/selector_test.go`
- `internal/skills/render_test.go`
...
```bash
git add internal/skills/selector.go internal/skills/render.go internal/skills/selector_test.go internal/skills/render_test.go
...
- `internal/kernel/kernel_test.go` coverage for skill-block injection
- `internal/skills/usage_test.go`
...
```bash
git add internal/skills/usage.go internal/skills/usage_test.go internal/kernel/kernel.go internal/kernel/kernel_test.go
