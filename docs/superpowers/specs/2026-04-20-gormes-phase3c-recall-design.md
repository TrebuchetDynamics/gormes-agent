...
- [`docs/ARCH_PLAN.md`](../../ARCH_PLAN.md) — Phase 3 = "The Black Box (Memory)". 3.A poured the concrete (SQLite + FTS5), 3.B built the Brain that writes to it (LLM extractor), 3.C is what lets the kernel *read* from it before each turn.
