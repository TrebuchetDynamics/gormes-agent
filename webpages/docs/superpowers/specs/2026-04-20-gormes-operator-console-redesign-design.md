...
**Scope:** Redesign `www.gormes.ai` from a generic dark landing page into an aggressive operator-console page aimed at existing Hermes users who should try Gormes locally now.
