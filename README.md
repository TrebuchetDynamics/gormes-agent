...
Latest public release: [v0.2.25](https://github.com/TrebuchetDynamics/gormes-agent/releases/tag/v0.2.25) (`v2026.6.19`).

Termux/Android status: `v0.2.25` carries forward the installer recovery for the `v0.2.20` Termux executable-argument issue. Affected users should reinstall from the latest release and verify with `gormes version` plus `gormes doctor --offline`.
