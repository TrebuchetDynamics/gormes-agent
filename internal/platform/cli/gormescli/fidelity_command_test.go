...
func TestFidelityHermesCommandJSONReportOnly(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newFidelityRootCommandForTest(),
		"fidelity", "hermes",
		"--repo-root", root,
...
func newFidelityRootCommandForTest() *cobra.Command {
	return newRootCommandWithFactoryForTest("fidelity", func() *cobra.Command {
		return NewFidelityCommand(FidelityCommandOptions{
			Build:         func() any { return testBuildProvenance() },
