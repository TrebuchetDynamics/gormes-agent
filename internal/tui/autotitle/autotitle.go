...
// Input captures the post-turn state the TUI needs to decide whether
...
// Request is the eligibility-resolved descriptor a later wiring row
...
// BuildRequest decides whether a completed TUI turn is eligible for
...
func BuildRequest(in Input) (Request, bool) {
