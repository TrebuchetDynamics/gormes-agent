...
For detailed installation options, prerequisites, and troubleshooting, see the [Installation guide](../installation/).
...
For most first-time users: choose a provider, accept the defaults unless you know why you're changing them. The full provider catalog with env vars and setup steps lives on the [Providers](../../integrations/providers/) page.
...
> **Tip**
> You can switch providers at any time with `hermes model` — no lock-in. For a full list of all supported providers and setup details, see [AI Providers](../../integrations/providers/).
...
Connect [Telegram](../../user-guide/messaging/telegram/), [Discord](../../user-guide/messaging/discord/), [Slack](../../user-guide/messaging/slack/), [WhatsApp](../../user-guide/messaging/whatsapp/), [Signal](../../user-guide/messaging/signal/), [Email](../../user-guide/messaging/email/), or [Home Assistant](../../user-guide/messaging/homeassistant/).
...
Then in the CLI: `/voice on`. Press `Ctrl+B` to record. See [Voice Mode](../../user-guide/features/voice-mode/).
...
See [ACP Editor Integration](../../user-guide/features/acp/).
...
- **[AI Providers](../../integrations/providers/)** — Full provider list and setup details
- **[Skills System](../../user-guide/features/skills/)** — Reusable workflows and knowledge
- **[Tips & Best Practices](../../guides/tips/)** — Power user tips
