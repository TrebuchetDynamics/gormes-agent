...
| Related skills | [`kanban-worker`](https://hermesagent.ai/docs/user-guide/skills/bundled/devops/devops-kanban-worker), [`codex`](https://hermesagent.ai/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`hermes-agent`](https://hermesagent.ai/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) |
