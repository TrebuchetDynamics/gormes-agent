// Package panels renders Hermes-compatible modal/tool-progress panels.
//
...
// Styles is the subset of the root TUI skin style set used by panel renderers.
type Styles struct {
...
func RenderApprovalPanel(s ApprovalPanelState) string {
	return renderApprovalPanel(s, Styles{}, false)
}

func RenderApprovalPanelWithStyles(s ApprovalPanelState, styles Styles) string {
	return renderApprovalPanel(s, styles, true)
}

func renderApprovalPanel(s ApprovalPanelState, styles Styles, styled bool) string {
...
func RenderClarifyPanel(s ClarifyPanelState) string {
	return renderClarifyPanel(s, Styles{}, false)
}

func RenderClarifyPanelWithStyles(s ClarifyPanelState, styles Styles) string {
	return renderClarifyPanel(s, styles, true)
}

func renderClarifyPanel(s ClarifyPanelState, styles Styles, styled bool) string {
...
func RenderSecretPanel(s SecretPanelState) string {
	return renderSecretPanel(s, Styles{}, false)
}

func RenderSecretPanelWithStyles(s SecretPanelState, styles Styles) string {
	return renderSecretPanel(s, styles, true)
}

func renderSecretPanel(s SecretPanelState, styles Styles, styled bool) string {
...
func boxifyWithStyles(body []string, styles Styles, styled bool) string {
	width := 0
