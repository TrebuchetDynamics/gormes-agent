...
|---|---|---|---|---|
| 5 / 5.E | whisper.cpp WASI module discovery | wazero WASI smoke harness | Row A 'wazero WASI smoke harness' is complete; wazero is in go.mod with a pinned release. | Pure-Go Whisper transcribe one WAV |
