...
func TestTTSPiperListShowsCachedModels(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newRootCommand(), "tts", "piper", "list")
	if err != nil {
...
func TestTTSPiperVoicesShowsNamedInstallShortcuts(t *testing.T) {
	stdout, stderr, err := executeRootCommandForTest(newRootCommand(), "tts", "piper", "voices")
	if err != nil {
...
func TestTTSPiperCleanUnusableRemovesOnlyBrokenModels(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newRootCommand(), "tts", "piper", "clean", "--unusable")
	if err != nil {
...
func TestTTSPiperCleanRequiresUnusableFlag(t *testing.T) {
	restoreTTSPiperCommandEnv(t)
	stdout, stderr, err := executeRootCommandForTest(newRootCommand(), "tts", "piper", "clean")
...
func TestTTSPiperInstallNamedVoiceDownloadsIntoCache(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newRootCommand(), "tts", "piper", "install", "lessac-medium")
	if err != nil {
...
func TestTTSPiperInstallCopiesModelIntoCache(t *testing.T) {
	...
	stdout, stderr, err := executeRootCommandForTest(newRootCommand(), "tts", "piper", "install", source)
	if err != nil {
