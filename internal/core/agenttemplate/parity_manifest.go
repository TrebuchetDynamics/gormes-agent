	...
	return []TemplatePair{
		{
			...
			GormesSources: []string{
				...
				"internal/core/agenttemplate/default_templates.go",
			},
			...
			TestGate: []string{
				"go test ./internal/llm -run TestDefaultSoulMD -count=1",
				"go test ./internal/core/agenttemplate -count=1",
			},
		...
		},
		{
			...
			GormesSources: []string{
				"internal/llm/durable_user_context.go",
				"internal/core/agenttemplate/default_templates.go",
			},
