...
func (e *ToolEventEmitter) EmitStart(source string, req ToolRequest) error {
	return e.emit(TopicToolStart, source, req, nil, nil)
}

func (e *ToolEventEmitter) EmitOutput(source string, req ToolRequest, output json.RawMessage) error {
	return e.emit(TopicToolOutput, source, req, output, nil)
}

func (e *ToolEventEmitter) EmitProgress(source string, req ToolRequest, output json.RawMessage) error {
	return e.emit(TopicToolProgress, source, req, output, nil)
}

func (e *ToolEventEmitter) EmitComplete(source string, req ToolRequest) error {
	return e.emit(TopicToolComplete, source, req, nil, nil)
}

func (e *ToolEventEmitter) EmitError(source string, req ToolRequest, err error) error {
	if err == nil {
...
func (e *ToolEventEmitter) emit(topic, source string, req ToolRequest, output json.RawMessage, emitErr error) error {
	if e == nil || e.bus == nil {
		return nil
	}
...
func (e *EventingToolExecutor) Execute(ctx context.Context, req ToolRequest) (<-chan ToolEvent, error) {
...
func (e *EventingToolExecutor) emitFromToolEvent(req ToolRequest, event ToolEvent) error {
	switch event.Type {
	case "started":
...
func (e *EventingToolExecutor) emitError(req ToolRequest, err error) error {
...
func toolEventTraceID(req ToolRequest, callID string) string {
	if callID != "" {
		return callID
	}
	if req.AgentID != "" {
