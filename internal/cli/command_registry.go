...
var CommandRegistry = []CommandPolicy{
	...
	{Name: "kanban", Description: "Manage the durable multi-agent task board", Surface: CommandSurfaceShared, ActiveTurnPolicy: ActiveTurnPolicyUnavailable, Subcommands: []string{"init", "create", "list", "show", "claim", "complete", "block", "unblock", "link"}},
