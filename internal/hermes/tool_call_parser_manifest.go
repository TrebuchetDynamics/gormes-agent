	...
	entries := []ToolCallParserEntry{
		{
			...
			TargetGoPackage:    "internal/hermes/toolcallparsers/deepseekv31",
			GoldenFixtures: []string{
		...
		},
		{
			...
			TargetGoPackage:    "internal/hermes/toolcallparsers/deepseekv3",
		},
		{
			...
			Status:             ToolCallParserStatusRowBacked,
			TargetGoPackage:    "internal/hermes/toolcallparsers/glm45",
		},
		{
			...
			Status:             ToolCallParserStatusRowBacked,
			TargetGoPackage:    "internal/hermes/toolcallparsers/glm47",
		},
		{
			...
			Status:             ToolCallParserStatusMapped,
			TargetGoPackage:    "internal/hermes/toolcallparsers/hermes",
			GoldenFixtures: []string{
				"hermes_basic.json",
		...
		},
		{
			...
			Status:             ToolCallParserStatusRowBacked,
			TargetGoPackage:    "internal/hermes/toolcallparsers/kimik2",
		},
		{
			...
			Status:             ToolCallParserStatusRowBacked,
			TargetGoPackage:    "internal/hermes/toolcallparsers/llama",
		},
		{
			...
			Status:             ToolCallParserStatusRowBacked,
			TargetGoPackage:    "internal/hermes/toolcallparsers/longcat",
		},
		{
			...
			Status:             ToolCallParserStatusRowBacked,
			TargetGoPackage:    "internal/hermes/toolcallparsers/mistral",
		},
		{
			...
			Status:             ToolCallParserStatusRowBacked,
			TargetGoPackage:    "internal/hermes/toolcallparsers/qwen3coder",
		},
		{
			...
			ExpectedInputStyle: "tool_call_xml_json_body",
			Status:             ToolCallParserStatusRowBacked,
			TargetGoPackage:    "internal/hermes/toolcallparsers/qwen",
		},
	}
