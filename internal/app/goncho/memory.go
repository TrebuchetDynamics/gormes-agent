...
// RunGonchoMemorySearch executes the goncho memory search command.
...
// RunGonchoMemoryInspect executes the goncho memory inspect command.
...
// OpenGonchoService opens the goncho memory database and creates a service.
