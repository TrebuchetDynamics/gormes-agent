...
func newPluginsCommandWithManager(manager any) *cobra.Command {
	return NewPluginsCommandWithManager(manager, PluginsOptions{
		BuildProvenance: func() PluginsBuildProvenance {
			return PluginsBuildProvenance{Version: Version, GitCommit: "test-commit"}
		},
	})
}
