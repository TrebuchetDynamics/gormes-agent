...
| 7 | Goncho HTTP route parity over OpenAPI v3 | 3.G/5.Q | `internal/goncho/http/*` | `go test ./internal/goncho/http -count=1` | row-backed |
| 8 | Goncho CLI command-tree parity | 3.G/5.O | `cmd/gormes/goncho*.go`, `cmd/gormes/goncho_cli_parity_test.go` | `go test ./cmd/gormes -run GonchoCLIParity -count=1` | row-backed |
