...
func TestWakeLockManager_AcquireRelease_NonTermux(t *testing.T) {
	m := WakeLockManager{Env: map[string]string{}}
...
func TestWakeLockManager_AcquireRelease_TermuxMissingCommand(t *testing.T) {
	m := WakeLockManager{
...
func TestWakeLockManager_AcquireRelease_TermuxSuccess(t *testing.T) {
	var calls []struct {
		cmd  string
		args []string
	}
...
func TestWakeLockManager_Release_OnlyReleaseFlag(t *testing.T) {
	var calls []struct {
		args []string
	}
	m := WakeLockManager{
