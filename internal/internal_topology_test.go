...
func protectedHermesOwnerSeams() []hermesOwnerSeam {
	return []hermesOwnerSeam{
		...
		},
		{
			...
			GormesRoots: []string{"internal/provider", "internal/hermes", "internal/extensibility/plugins"},
		},
		{
			OwnerModule: "tools",
	...
	return []topologyMigration{
		...
		},
		{
			...
			SourceRefs: []string{
				...
				"internal/planning/progress/builderloop/run.go:emitPlannerTriggers",
				"internal/planning/progress/plannerloop/run.go:Run",
			},
		},
		{
			...
			NewRoots:    []string{"internal/planning/progress/builderloop"},
			SourceRefs: []string{
				"internal/REFACTOR-CMD-PLAN.md:Progress Delivery Enclave",
				"internal/REFACTOR-CMD-PLAN.md:Package Move Playbook",
				"internal/planning/progress/builderloop/run.go:RunOnce",
				"internal/planning/progress/ctl/progressctl.go:NextWorkWithOptions",
				"internal/planning/progress/plannerloop/run.go:Run",
			},
		},
		{
			...
			SourceRefs: []string{
				...
				"internal/planning/progress/builderloop/candidates.go:NormalizeCandidates",
			},
		},
		{
			Name:        "repoctl-rehome",
