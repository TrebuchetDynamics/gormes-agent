...
func stubKanbanTriageSpecifier(specifier kanban.TriageSpecifier) func() {
	t := &cleanupCollector{}
	SetKanbanTriageSpecifierForTesting(t, func(config.Config) (kanban.TriageSpecifier, error) {
...
func (c *cleanupCollector) Cleanup(fn func()) { c.cleanup = fn }

func (c *cleanupCollector) runCleanup() {
	if c.cleanup != nil {
		c.cleanup()
	}
}
