...
**Files:**
- Create: `internal/goncho/types.go`
- Create: `internal/goncho/contracts_test.go`
...
**Files:**
- Create: `internal/goncho/service.go`
- Create: `internal/goncho/sql.go`
- Create: `internal/goncho/service_test.go`
