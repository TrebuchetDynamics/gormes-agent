...
| 8 / 8.D | Gormes-owned session-aware welcome panel | Gormes-owned chat TUI divergence ratification | Gormes-owned chat TUI divergence ratification is complete (EmptyTranscriptIntro no longer mandates the exact Hermes string). | - |
| 8 / 8.D | Gormes-owned semantic chat style system | Gormes-owned chat TUI divergence ratification | Gormes-owned chat TUI divergence ratification is complete (role labels/styling no longer forbidden by fidelity goldens). | - |
| 8 / 8.D | Gormes-owned streaming feedback uplift | Gormes-owned chat TUI divergence ratification | Gormes-owned chat TUI divergence ratification is complete (transcript chrome may change). | - |
<!-- PROGRESS:END -->
