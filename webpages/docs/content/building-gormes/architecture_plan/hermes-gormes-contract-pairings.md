...
| `session.recap.command` | `../hermes-agent/hermes_cli/session_recap.py` | planned `cmd/gormes session recap`; `internal/session`; `internal/store` | functional | planned | draft |
...
| `acp.browser_bootstrap.setup` | `../hermes-agent/acp_adapter/bootstrap/bootstrap_browser_tools.sh`; `../hermes-agent/acp_adapter/bootstrap/bootstrap_browser_tools.ps1` | planned `gormes acp --setup-browser`; `internal/acp`; `internal/tools` | functional | planned | draft |
