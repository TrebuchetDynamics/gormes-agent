...
**Reference spec:** `docs/superpowers/specs/2026-04-23-gormes-installer-parity-design.md`
...
www.gormes.ai/internal/site/install_windows_test.go
```
...
- `README.md`, `README.md`, `www.gormes.ai/README.md`: user-facing install/update guidance.
...
**Files:**
- Modify: `www.gormes.ai/internal/site/assets.go`
- Modify: `www.gormes.ai/internal/site/server.go`
- Modify: `www.gormes.ai/internal/site/assets_test.go`
...
Add these test bodies to `www.gormes.ai/internal/site/assets_test.go`:
...
Extend `www.gormes.ai/internal/site/static_export_test.go` with:
...
Update `www.gormes.ai/internal/site/assets.go`:
...
Update `www.gormes.ai/internal/site/server.go`:
...
```bash
git add www.gormes.ai/internal/site/assets.go \
        www.gormes.ai/internal/site/server.go \
        www.gormes.ai/internal/site/assets_test.go \
        www.gormes.ai/internal/site/static_export_test.go
...
```bash
cd www.gormes.ai/internal/site
...
**Files:**
- Create: `www.gormes.ai/internal/site/install.ps1`
- Create: `www.gormes.ai/internal/site/install.cmd`
- Create: `www.gormes.ai/internal/site/install_windows_test.go`
...
Write `www.gormes.ai/internal/site/install.ps1`:
...
Write `www.gormes.ai/internal/site/install.cmd`:
...
```bash
git add www.gormes.ai/internal/site/install.ps1 \
        www.gormes.ai/internal/site/install.cmd \
        www.gormes.ai/internal/site/install_windows_test.go
...
Update `www.gormes.ai/internal/site/static_export_test.go`:
...
Update `www.gormes.ai/internal/site/content.go`:
...
Update `README.md` install block to contain this shape:
