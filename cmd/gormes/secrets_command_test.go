...
func TestSecretsSnapshotWritePreservesSymlink(t *testing.T) {
	home := t.TempDir()
	...
	err := writeSecretsSnapshotFile(toolspkg.SecretsRuntimeSnapshot{
	...
	if err != nil {
		t.Fatalf("writeSecretsSnapshotFile: %v", err)
	}
