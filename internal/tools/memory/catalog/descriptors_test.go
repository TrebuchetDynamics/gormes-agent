...
func assertMemoryToolDescriptorEnvelope(t *testing.T, descriptor toolkit.ToolDescriptor) {
	t.Helper()
...
func assertMemoryToolSchema(t *testing.T, descriptors []toolkit.ToolDescriptor, name string, required, properties []string) {
	t.Helper()
...
func memoryToolDescriptorByName(descriptors []toolkit.ToolDescriptor, name string) (toolkit.ToolDescriptor, bool) {
	for _, descriptor := range descriptors {
		if descriptor.Name == name {
			return descriptor, true
		}
	}
	return toolkit.ToolDescriptor{}, false
}
