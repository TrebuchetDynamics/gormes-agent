...
rg -n "gormes doctor|install|offline|gateway|Goncho|Honcho|Hermes-compatible|single static binary|supported|deferred" README.md cmd internal docs www.gormes.ai
```
