...
import (
	"github.com/TrebuchetDynamics/gormes-agent/internal/tui/skin/tokens"
...
func NormalizeStyleSkin(skin tokens.HermesSkin) tokens.HermesSkin {
	return tokens.NormalizeSkin(skin)
}

func ChatPaletteFor(skin tokens.HermesSkin) ChatPalette {
...
func SkinStylesFor(skin tokens.HermesSkin) SkinStyles {
	skin = NormalizeStyleSkin(skin)
...
func ChatStylesFor(skin tokens.HermesSkin) ChatStyles {
...
func ApplyTextareaSkin(input *textarea.Model, skin tokens.HermesSkin) {
	if input == nil {
		return
	}
	styles := SkinStylesFor(skin)
...
func ApplyTextInputSkin(input *textinput.Model, skin tokens.HermesSkin) {
	if input == nil {
		return
	}
	styles := SkinStylesFor(skin)
