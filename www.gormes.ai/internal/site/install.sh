...
#   GORMES_MODULE   — go install target (default: github.com/TrebuchetDynamics/gormes-agent/cmd/gormes)
...
MODULE="${GORMES_MODULE:-github.com/TrebuchetDynamics/gormes-agent/cmd/gormes}"
