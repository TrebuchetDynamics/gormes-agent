...
import (
	...
	"github.com/TrebuchetDynamics/gormes-agent/internal/platform/cli/gormescli/modules/gateway/rowbacked"
)

type Options = rowbacked.Options

const GatewayCronRow = rowbacked.GatewayCronRow
