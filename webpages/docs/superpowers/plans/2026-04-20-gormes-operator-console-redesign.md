...
**Goal:** Redesign `www.gormes.ai` into an aggressive operator-console landing page that converts existing Hermes users into trying Gormes locally now, stays truthful about shipped scope, and works cleanly on mobile.
...
- Work from `<repo>/www.gormes.ai` unless a step explicitly targets the repo root.
...
- Test: `www.gormes.ai/internal/site/render_test.go`
...
Use the fresh result to update `www.gormes.ai/internal/site/content.go`. The minimal code change should be:
...
```text
ok  	github.com/TrebuchetDynamics/gormes-agent/www.gormes.ai/internal/site
```
...
```bash
git add www.gormes.ai/internal/site/content.go www.gormes.ai/internal/site/render_test.go
...
- Add: `www.gormes.ai/internal/site/templates/partials/command_step.tmpl`
- Add: `www.gormes.ai/internal/site/templates/partials/ops_module.tmpl`
- Add: `www.gormes.ai/internal/site/templates/partials/proof_stat.tmpl`
- Add: `www.gormes.ai/internal/site/templates/partials/ship_state.tmpl`
- Delete: `www.gormes.ai/internal/site/templates/partials/code_block.tmpl`
- Delete: `www.gormes.ai/internal/site/templates/partials/feature_card.tmpl`
- Delete: `www.gormes.ai/internal/site/templates/partials/phase_item.tmpl`
- Test: `www.gormes.ai/internal/site/render_test.go`
- Test: `www.gormes.ai/internal/site/static_export_test.go`

- [ ] **Step 1: Write the failing structure tests**

Update `www.gormes.ai/internal/site/render_test.go` so the main render test asserts the new operator-console sections:
...
Update `www.gormes.ai/internal/site/static_export_test.go` so the exported page also asserts:
...
Expand `www.gormes.ai/internal/site/content.go` with explicit operator-console structures:
...
Replace `www.gormes.ai/internal/site/templates/index.tmpl` with:
...
`www.gormes.ai/internal/site/templates/partials/command_step.tmpl`
...
Adjust `www.gormes.ai/internal/site/templates/layout.tmpl` so the nav and footer labels match the new operator-console structure:
...
git add www.gormes.ai/internal/site/content.go \
        www.gormes.ai/internal/site/render_test.go \
        ...
        www.gormes.ai/internal/site/templates/partials
...
- Test: `www.gormes.ai/tests/home.spec.mjs`

- [ ] **Step 1: Write the failing desktop + mobile browser smoke tests**

Replace `www.gormes.ai/tests/home.spec.mjs` with:
...
```bash
git add www.gormes.ai/internal/site/static/site.css www.gormes.ai/tests/home.spec.mjs
