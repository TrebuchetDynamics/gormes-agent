...
func BuildSessionTreePage(tree SessionTreeResult) (TransientPageState, bool) {
	...
	filter := normalizeTreeSlashFilter(tree.Filter)
	...
	return TransientPageState{Title: title, Body: strings.Join(blocks, "\n")}, true
}
...
func normalizeTreeSlashFilter(raw string) string {
