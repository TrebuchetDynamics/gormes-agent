...
**Tech Stack:** Hugo markdown under `docs/content`, existing docs navigation patterns, donor references from `<picoclaw donor repo>`, verification via `cd gormes && go test ./docs -run TestHugoBuild -count=1`.

---

## Prerequisites

- Approved spec: `docs/superpowers/specs/2026-04-20-gormes-gateway-donor-map-design.md`
- Donor repo available locally at `<picoclaw donor repo>`
- Gormes repo root: `<repo>`
- Hugo smoke test already exists in `docs/build_test.go`
...
**Files:**
- Create: `docs/content/building-gormes/gateway-donor-map/_index.md`
- Modify: `docs/content/building-gormes/_index.md`
- Modify: `docs/content/building-gormes/core-systems/gateway.md`
...
```bash
git add docs/content/building-gormes/_index.md \
  docs/content/building-gormes/core-systems/gateway.md \
  docs/content/building-gormes/architecture_plan/phase-2-gateway.md \
  docs/content/building-gormes/gateway-donor-map/_index.md
...
**Files:**
- Create: `docs/content/building-gormes/gateway-donor-map/shared-adapter-patterns.md`
...
```bash
git add docs/content/building-gormes/gateway-donor-map/shared-adapter-patterns.md
...
**Files:**
- Create: `docs/content/building-gormes/gateway-donor-map/telegram.md`
- Create: `docs/content/building-gormes/gateway-donor-map/discord.md`
- Create: `docs/content/building-gormes/gateway-donor-map/slack.md`
- Create: `docs/content/building-gormes/gateway-donor-map/whatsapp.md`
...
```bash
git add docs/content/building-gormes/gateway-donor-map/telegram.md \
  docs/content/building-gormes/gateway-donor-map/discord.md \
  docs/content/building-gormes/gateway-donor-map/slack.md \
  docs/content/building-gormes/gateway-donor-map/whatsapp.md
...
**Files:**
- Create: `docs/content/building-gormes/gateway-donor-map/matrix.md`
- Create: `docs/content/building-gormes/gateway-donor-map/irc.md`
- Create: `docs/content/building-gormes/gateway-donor-map/line.md`
- Create: `docs/content/building-gormes/gateway-donor-map/onebot.md`
- Create: `docs/content/building-gormes/gateway-donor-map/qq.md`
- Create: `docs/content/building-gormes/gateway-donor-map/webhook.md`
...
```bash
git add docs/content/building-gormes/gateway-donor-map/matrix.md \
  docs/content/building-gormes/gateway-donor-map/irc.md \
  docs/content/building-gormes/gateway-donor-map/line.md \
  docs/content/building-gormes/gateway-donor-map/onebot.md \
  docs/content/building-gormes/gateway-donor-map/qq.md \
  docs/content/building-gormes/gateway-donor-map/webhook.md
...
**Files:**
- Create: `docs/content/building-gormes/gateway-donor-map/wecom.md`
- Create: `docs/content/building-gormes/gateway-donor-map/weixin.md`
- Create: `docs/content/building-gormes/gateway-donor-map/feishu.md`
- Create: `docs/content/building-gormes/gateway-donor-map/dingtalk.md`
- Create: `docs/content/building-gormes/gateway-donor-map/vk.md`
...
```bash
git add docs/content/building-gormes/gateway-donor-map/wecom.md \
  docs/content/building-gormes/gateway-donor-map/weixin.md \
  docs/content/building-gormes/gateway-donor-map/feishu.md \
  docs/content/building-gormes/gateway-donor-map/dingtalk.md \
  docs/content/building-gormes/gateway-donor-map/vk.md
...
**Files:**
- Modify: `docs/content/building-gormes/gateway-donor-map/_index.md`
- Modify: every dossier under `docs/content/building-gormes/gateway-donor-map/` if consistency fixes are needed
...
```bash
git diff --stat -- docs/content/building-gormes docs/superpowers
git diff -- docs/content/building-gormes/gateway-donor-map
```
